...
if not st.session_state.formulario_preenchido:
    ...
    aba_diagnostico, aba_fpa_kpi, aba_fpa_ebitda = st.tabs([
        "📋 Diagnóstico de Maturidade", 
        "📈 FP&A: Indicadores", 
        "💎 FP&A: Endividamento & EBITDA"
    ])
    ...
    # --- ABA 2: FP&A (Indicadores de Liquidez, Rentabilidade e Ciclos) ---
    with aba_fpa_kpi:
    ...
    # --- ABA 3: FP&A (Endividamento e EBITDA) ---
    with aba_fpa_ebitda:
        st.markdown('<div class="main-title">REALI PREMIUM</div>', unsafe_allow_html=True)
        st.markdown('<div class="sub-title">CFO & CEO | Estrutura de Capital e EBITDA</div>', unsafe_allow_html=True)
        st.divider()
